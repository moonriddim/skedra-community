...
const statements = [
	...
	"ALTER TABLE whiteboards ADD COLUMN IF NOT EXISTS e2ee_enabled boolean NOT NULL DEFAULT true",
	"ALTER TABLE whiteboards ALTER COLUMN e2ee_enabled SET DEFAULT true",
