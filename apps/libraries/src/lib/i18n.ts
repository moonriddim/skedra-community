...
const messages = {
	de: {
		...
		previewLoading: "Symbolvorschau wird geladen",
		previewUnavailable: "Für dieses Paket ist keine Vorschau verfügbar.",
		moreItems: (count: number) => `+ ${count} weitere Symbole`,
	...
	en: {
		...
		previewLoading: "Loading shape preview",
		previewUnavailable: "No preview is available for this package.",
		moreItems: (count: number) => `+ ${count} more shapes`,
